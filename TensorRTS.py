...
LinearRTS, the first epoch of TensorRTS, is intended to be the simplest RTS game.
    ...
    def obs_space(cls) -> ObsSpace: # given
        return ObsSpace(
            entities={
    ...
    def action_space(cls) -> Dict[ActionName, ActionSpace]: #given
        return {
    ...
    def reset(self) -> Observation: # given
        positions = set()
    ...
    def tensor_power(self, tensor_index) -> float : #given
    ...
    def observe(self) -> Observation: # given
